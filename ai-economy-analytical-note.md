...
## Соответствие буквенных обозначений секторов KLEMS российским отраслям

Все десять секторов модели опираются на классификацию KLEMS (совместима с разделами ОКВЭД-2). В таблице ниже зафиксированы канонические русскоязычные ярлыки и пояснения по проксированию, которые используются по всему отчёту и в коде проекта.

| Код | Русскоязычное название отрасли | Соответствие в Russia KLEMS / комментарий |
| --- | --- | --- |
| B | Добыча полезных ископаемых | Раздел B ОКВЭД-2; полностью покрывается Russia KLEMS. |
| C | Обрабатывающая промышленность (без машиностроения) | Раздел C ОКВЭД-2 за вычетом машиностроительной части; в модели — остаток после выделения C_mach. |
| C_mach | Машиностроение (proxy внутри C) | ОКВЭД-2 коды 26–30 внутри раздела C; доля около 21% обрабатывающей промышленности по P-1 (см. `scripts/build_cmach_share_proxy.py`). |
| DE | Энергетика и коммунальная инфраструктура | Объединение разделов D (электроэнергия, газ, пар) и E (водоснабжение, отходы, очистка) Russia KLEMS. |
| F | Строительство | Раздел F ОКВЭД-2; полностью покрывается Russia KLEMS. |
| G | Оптовая и розничная торговля | Раздел G ОКВЭД-2; в Russia KLEMS соответствует агрегату 50t52 (торговля и ремонт автотранспорта). |
| H | Транспортировка и хранение | Раздел H ОКВЭД-2; полностью покрывается Russia KLEMS. |
| J | Информация и связь (ИТ и связь) | Раздел J ОКВЭД-2; программный класс диффузии ИИ. |
| K | Финансовая и страховая деятельность | Раздел K ОКВЭД-2; программный класс диффузии ИИ. |
| M | Профессиональная, научная и техническая деятельность | Раздел M ОКВЭД-2; программный класс диффузии ИИ. |
