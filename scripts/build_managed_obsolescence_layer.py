...
def load_ict_usage() -> pd.DataFrame:
    ...
    rows = {
        ...
        "C_mach_1": "Производство компьютеров, электронных и оптических изделий",
        "C_mach_2": "Производство электрического оборудования",
        "C_mach_3": "Производство машин и оборудования, не включенных в другие группировки",
        "C_mach_4": "Производство автотранспортных средств, прицепов и полуприцепов",
        "C_mach_5": "Производство прочих транспортных средств и оборудования",
    ...
    for key, label in rows.items():
        sector_id = "DE" if key.startswith("DE_") else "C_mach" if key.startswith("C_mach_") else key
...
def load_fixed_asset_renewal() -> pd.DataFrame:
    ...
    rows = {
        ...
        "C": "обрабатывающие производства",
        "C_mach": "обрабатывающие производства",
