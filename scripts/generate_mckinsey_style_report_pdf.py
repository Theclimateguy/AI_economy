...
def page_russia(pdf: PdfPages) -> None:
    ...
    text_left = (
        "C — наиболее надежный материальный сигнал: чистый маппинг Russia KLEMS, высокий productivity-hours gap и существенная занятость. "
...
def page_forecast_and_qr(pdf: PdfPages) -> None:
    ...
    conclusions = (
        ...
        "4. Manufacturing (C) — главный надежный российский сигнал; J/M трактуются осторожно из-за слабого KLEMS proxy."
    )
...
def page_appendix_klems(pdf: PdfPages) -> None:
    ...
    note = (
        "В проекте используется агрегированная карта: B — добыча, C — обработка, DE — энергетика и ЖКХ, F — строительство, H — транспорт, J — ИТ и связь, K — финансы, M — профессиональные и научные услуги. "
